    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <div
            ref={posterRef}
            className="bg-gradient-to-br from-primary/10 via-accent to-primary/5 p-6"
          >
          ...
          <div className="p-4 flex gap-3">
            ...
            <button
              ...
              className="flex-1 py-3 px-4 rounded-lg bg-primary text-primary-foreground font-medium flex items-center justify-center gap-2 disabled:opacity-50"
            >
